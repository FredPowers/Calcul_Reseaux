...
if ($MasqueCIDR_VPN -eq 0)
    ...
    write-Host "Configuration IP actuelle de la machine :" -ForegroundColor DarkGreen
    ...
    write-Host "Configuration IP de la connexion VPN :" -ForegroundColor DarkGreen
...
$AdresseIPHost = Read-host "Entrer une adresse IP"

Write-Host ""

$MasqueHost = Read-Host "Entrer le masque de sous-réseaux au format Décimal/4octets"
